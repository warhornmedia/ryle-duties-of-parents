...
\hypersetup{
  pdftitle={The Duties of Parents: How should a child be trained?},
  pdfauthor={J. C. Ryle},
  hidelinks,
...
\begin{center}\includegraphics[width=0.5\linewidth]{/home/travis/build/warhornmedia/ryle-duties-of-parents/classics-template-files/images/whitelogo} \end{center}
...
\hypertarget{recent-updates-to-this-book}{%
\subsubsection*{Recent updates to this book}\label{recent-updates-to-this-book}}
\addcontentsline{toc}{subsubsection}{Recent updates to this book}
...
\addcontentsline{toc}{section}{1. First, then, if you would train your children rightly, train them in the way they should go---and not in the way that they desire.}
...
\addcontentsline{toc}{section}{2. Train up your child with all tenderness, affection, and patience.}
...
\addcontentsline{toc}{section}{3. Train your children with an abiding persuasion on your mind that much depends upon you.}
...
\addcontentsline{toc}{section}{4. Train with this thought continually before your eyes---that the soul of your child is the first thing to be considered.}
...
\addcontentsline{toc}{section}{5. Train your child to a knowledge of the Bible.}
...
\addcontentsline{toc}{section}{6. Train them to a habit of Prayer.}
...
\addcontentsline{toc}{section}{7. Train them to habits of diligence, and regularity about public means of grace.}
...
\addcontentsline{toc}{section}{8. Train them to a habit of faith.}
...
\addcontentsline{toc}{section}{9. Train them to a habit of OBEDIENCE.}
...
\addcontentsline{toc}{section}{10. Train them to a habit of always speaking the truth.}
...
\addcontentsline{toc}{section}{11. Train them to a habit of always redeeming the TIME.}
...
\addcontentsline{toc}{section}{12. Train them with a constant fear of over-indulgence.}
...
\addcontentsline{toc}{section}{13. Train them remembering continually how God trains His children.}
...
\addcontentsline{toc}{section}{14. Train them remembering continually the influence of your own example.}
...
\addcontentsline{toc}{section}{15. Train them, remembering continually the power of sin.}
...
\addcontentsline{toc}{section}{16. Train them remembering continually the promises of Scripture.}
...
\addcontentsline{toc}{section}{17. Train them, lastly, with continual prayer for a blessing on all you do.}
