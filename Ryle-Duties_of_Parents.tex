...
\hypersetup{
  pdftitle={How Should a Child Be Trained?},
  pdfauthor={J. C. Ryle},
  hidelinks,
...
\title{How Should a Child Be Trained?}
\author{J. C. Ryle}
\date{1857}
...
\addcontentsline{toc}{chapter}{\href{https://classics.warhornmedia.com/}{A Warhorn Classics Book}}
...
\addcontentsline{toc}{chapter}{Sermon}
...
But after nature and grace, undoubtedly, there is nothing more powerful than education. Early habits (if I may so speak) are everything with us, under God. We are made what we are by early training. Our character takes the form of that mold into which our first years are cast.{[}\^{}2{]}
...
Learn to say ``No'' to your children. Show them that you are able to refuse whatever you think is not fit for them. Show them that you are ready to punish disobedience, and that when you speak of punishment, you are not only ready to threaten, but also to perform. Do not merely threaten.{[}\^{}4{]} Threatened folks, and threatened faults, live long. Punish seldom---but really and earnestly. Frequent and slight punishment is a wretched system indeed.{[}\^{}5{]}

{[}\^{}4:{]} Some parents have a way of saying, ``Naughty child,'' to a boy or girl on every slight occasion, and often without good cause. It is a very foolish habit. Words of blame should never be used without real reason.
